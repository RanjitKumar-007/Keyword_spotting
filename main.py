...
def build_pipeline(config: dict) -> tuple:
    ...
    return preprocessor, asr, translator, detector, confidence_threshold
...
def main(audio_file: str):
    ...
    try:
        ...
        preprocessor, asr, translator, detector, _ = (
            build_pipeline(config)
        )
        result = process_file(
            audio_file, preprocessor, asr, translator, detector
        )
...
if __name__ == "__main__":
    INPUT_AUDIO = r"audio_input/audio2.wav" # Input audio path
    main(INPUT_AUDIO)
